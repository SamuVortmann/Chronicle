      ...
      body: _loading
          ...
          : _albuns.isEmpty
              ? Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  const Text('Nenhum álbum ainda',
                      style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: _t1)),
                  const SizedBox(height: 6),
                  const Text('Toque em + para criar o primeiro.',
      ...
      child: Container(
        ...
        child: Row(children: [
          Container(
            ...
            child: Icon(_allIcons[album.icone] ?? Icons.photo_album_outlined,
                color: color, size: 26),
          ),
          ...
          IconButton(icon: const Icon(Icons.edit_outlined, size: 20, color: _t3),
              onPressed: onEdit),
    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(mainAxisSize: MainAxisSize.min,
          ...
          Text(widget.album == null ? 'Novo álbum' : 'Editar álbum',
              style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w700, color: _t1)),
          ...
          Center(child: Container(
            ...
            child: Icon(_allIcons[_icon] ?? Icons.photo_album_outlined,
                size: 32, color: color),
          )),
          const SizedBox(height: 16),

          // Nome
          const Text('NOME', style: TextStyle(fontSize: 11,
              fontWeight: FontWeight.w600, color: _t3, letterSpacing: 0.5)),
          ...
          // Descrição
          const Text('DESCRIÇÃO', style: TextStyle(fontSize: 11,
              fontWeight: FontWeight.w600, color: _t3, letterSpacing: 0.5)),
          const SizedBox(height: 5),
          TextField(
          ...
          // Icon picker
          const Text('ÍCONE', style: TextStyle(fontSize: 11,
              fontWeight: FontWeight.w600, color: _t3, letterSpacing: 0.5)),
          ...
          // Color picker
          const Text('COR', style: TextStyle(fontSize: 11,
              fontWeight: FontWeight.w600, color: _t3, letterSpacing: 0.5)),
          const SizedBox(height: 8),
          Row(children: _allColors.map((c) {
            final sel = _cor == c;
            final col = _hex(c);
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: sel ? [BoxShadow(color: col.withOpacity(0.5),
                      blurRadius: 6)] : null,
                ),
                child: sel ? const Icon(Icons.check, size: 14,
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Center(child: _saving
                  ...
                  : Text(widget.album == null ? 'Criar álbum' : 'Salvar',
